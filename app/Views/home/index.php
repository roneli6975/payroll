...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Content Wrapper -->
    <div id="content-wrapper" class="d-flex flex-column" style="min-height: 100vh; background-color: #131a2c;">

      <!-- Main Content -->
      <div id="content">

        <!-- Topbar -->
        <nav class="navbar navbar-expand navbar-dark topbar mb-4 static-top shadow" style="background-color: #131a2c;">
          ...
          <form
            ...
            <div class="input-group">
              <input type="text" class="form-control border-0 small" style="background-color: #292c4baf;" placeholder="Search for..."
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                ...
                <img class="img-profile rounded-circle" src="<?= base_url(); ?><?= user()->user_image ? 'img/' . user()->user_image : 'img/default.svg' ?>">
        ...
        <!-- Footer -->
        <footer class="sticky-footer" style="background-color: #131a2c;">
